...
export default function Footer({ locale, dict }: FooterProps) {
  ...
  const keywordsByLocale = {
    en: [
      { text: 'sup rent Georgia', href: `/${locale}/rent` },
      { text: 'sup board rental', href: `/${locale}/rent` },
      { text: 'surfboard sales', href: `/${locale}/shop` },
      { text: 'stand up paddle boarding', href: `/${locale}/services` },
      { text: 'buy sup board', href: `/${locale}/shop` },
      { text: 'water sports rental', href: `/${locale}/rent` },
    ],
    ge: [
      { text: 'საპ ბორდების გაქირავება', href: `/${locale}/rent` },
      { text: 'საპ რენტ', href: `/${locale}/rent` },
      { text: 'სერფინგი', href: `/${locale}/services` },
      { text: 'წყლის დაფა', href: `/${locale}/rent` },
      { text: 'საპების გაყიდვა', href: `/${locale}/shop` },
      { text: 'აქტიური დასვენება', href: `/${locale}/services` },
      { text: 'ვორტსპორტი', href: `/${locale}` },
    ],
    ru: [
      { text: 'аренда сап бордов', href: `/${locale}/rent` },
      { text: 'прокат сапов', href: `/${locale}/rent` },
      { text: 'сап серфинг', href: `/${locale}/services` },
      { text: 'купить сапборд', href: `/${locale}/shop` },
      { text: 'доски для серфинга', href: `/${locale}/shop` },
    ],
  };
